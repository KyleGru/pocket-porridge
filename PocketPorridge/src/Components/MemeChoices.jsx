  ...
  useEffect(() => {
    ...
    const sortMemes = async (memes) => {
      let memeSelectionArray = [
        ...
        102156234, 61579, 101470, 61544, 3218037, 370867422, 27813981, 224015000,
        316466202, 28251713, 100777631, 252758727, 259237855, 166969924,
        177682295, 247113703, 101956210, 155067746, 224514655, 216523697,
        77045868, 101288, 67452763, 61556, 5496396, 61520, 110133729, 14371066,
        29617627, 342785297, 196652226, 61532, 187102311, 175540452, 509760957,
        92084495,
      ];
